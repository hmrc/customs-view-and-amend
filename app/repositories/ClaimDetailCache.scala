...
class DefaultClaimDetailCache @Inject()(mongo: MongoComponent, config: Configuration)(implicit executionContext: ExecutionContext)
  extends PlayMongoRepository[ClaimsMongo](
    ...
    )) with ClaimDetailCache  {

}

case class ClaimDetailMongo()

trait ClaimDetailCache {
